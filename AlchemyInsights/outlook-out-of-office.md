...
---
# <a name="set-up-out-of-office-automatic-replies"></a>ตั้งค่าการตอบกลับอัตโนมัติของสํานักงาน

- [วิธีการตั้งค่าการตอบกลับอัตโนมัติบนกล่องจดหมายของผู้ใช้ใน Microsoft 365](https://docs.microsoft.com/exchange/troubleshoot/configure-mailboxes/set-automatic-replies)
