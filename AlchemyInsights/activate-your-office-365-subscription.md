...
- ถ้าคุณดาวน์โหลดแอปพลิเคชัน Office ของคุณแล้ว คุณอาจต้องลงชื่อเข้าใช้แอปพลิเคชันด้วยบัญชีที่โรงเรียนหรือที่โรงเรียน คุณสามารถอัปโหลดแอปพลิเคชันได้Officeแอปใดก็ได้ (Word, Excel และอื่นๆ) โดยการเลือก **ไฟล์ > บัญชี**(ใกล้ด้านล่าง) ภายใต้ ข้อมูลผู้ใช้ **ให้เลือก สลับ** บัญชี อ่านข้อมูลเพิ่มเติม ให้[อ่าน ติดตั้งOfficeของคุณ](https://docs.microsoft.com/microsoft-365/admin/setup/install-applications)
