...
ms.locfileid: "29493840"
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>เปิดไลบรารี SharePoint ในแฟ้ม Explorer

1. เรียกดูไลบรารีใน Internet Explorer 10 หรือ Internet Explorer 11 
    
2. คลิกไอคอนมุมมองในมุมขวาด้านบน และจากนั้น คลิ**กมุมมองใน Explorer แฟ้ม**
