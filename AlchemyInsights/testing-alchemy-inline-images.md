---
title: การทดสอบรูปแบบอินไลน์ขลัง
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="4e917-102">เข้าถึงหน้าโดเมน</span><span class="sxs-lookup"><span data-stu-id="4e917-102">Access the Domains Page</span></span>

<span data-ttu-id="4e917-103">เมื่อต้องการเข้าถึงหน้าโดเมนเพียงคลิกไอคอนนี้ที่ด้านล่าง:</span><span class="sxs-lookup"><span data-stu-id="4e917-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="4e917-104">จากนั้นคุณสามารถเพิ่มปรับเปลี่ยนหรือเอาโดเมนของคุณออกได้</span><span class="sxs-lookup"><span data-stu-id="4e917-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="4e917-105">สำหรับข้อมูลเพิ่มเติมให้ดูที่คำ [ถามที่ถามบ่อยเกี่ยวกับโดเมน](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="4e917-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
