...
เมื่อต้องการเข้าถึงหน้าโดเมนเพียงคลิกไอคอนนี้ที่ด้านล่าง:
...
จากนั้นคุณสามารถเพิ่มปรับเปลี่ยนหรือเอาโดเมนของคุณออกได้
สำหรับข้อมูลเพิ่มเติมให้ดูที่คำ [ถามที่ถามบ่อยเกี่ยวกับโดเมน](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
