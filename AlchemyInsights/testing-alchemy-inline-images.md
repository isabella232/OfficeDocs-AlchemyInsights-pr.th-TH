---
title: การทดสอบภาพแบบอินไลน์การเล่นแร่แปรธาตุ
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505074"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="fcf47-102">เข้าถึงหน้าโดเมน</span><span class="sxs-lookup"><span data-stu-id="fcf47-102">Access the Domains Page</span></span>

<span data-ttu-id="fcf47-103">หากต้องการเข้าถึงหน้าโดเมน เพียงคลิกที่ไอคอนด้านล่าง:</span><span class="sxs-lookup"><span data-stu-id="fcf47-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="fcf47-104">จากนั้นคุณสามารถเพิ่ม แก้ไข หรือลบโดเมนของคุณ</span><span class="sxs-lookup"><span data-stu-id="fcf47-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="fcf47-105">สําหรับข้อมูลเพิ่มเติม ให้ดูที่[คําถามที่ถามบ่อยเกี่ยวกับโดเมน](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="fcf47-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
