...
ms.locfileid: "36743148"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="8330f-102">เข้าถึงหน้าโดเมน</span><span class="sxs-lookup"><span data-stu-id="8330f-102">Access the Domains Page</span></span>

<span data-ttu-id="8330f-103">ในการเข้าถึงหน้าโดเมนเพียงคลิกที่ไอคอนนี้ด้านล่าง:</span><span class="sxs-lookup"><span data-stu-id="8330f-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="8330f-104">จากนั้นคุณสามารถเพิ่มแก้ไขหรือลบโดเมนของคุณได้</span><span class="sxs-lookup"><span data-stu-id="8330f-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="8330f-105">สำหรับข้อมูลเพิ่มเติมโปรดดูที่คำ[ถามที่พบบ่อยเกี่ยวกับโดเมน](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="8330f-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
