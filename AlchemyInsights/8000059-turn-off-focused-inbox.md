...
ms.locfileid: "29493984"
---
# <a name="turn-off-focused-inbox"></a><span data-ttu-id="a106c-102">ปิดเน้นกล่องขาเข้า</span><span class="sxs-lookup"><span data-stu-id="a106c-102">Turn off Focused Inbox</span></span>

<span data-ttu-id="a106c-p101">คุณมุ่งเพลิดช่วยกล่องขาเข้าที่โฟกัส คุณมักจะอ่านอีเมลปรากฏภายใต้ Focused และส่วนเหลือจะถูกย้ายไปยังที่อื่น เมื่อต้องการเรียนรู้ วิธีการทำงาน[อ่านนี้](https://support.office.com/article/f445ad7f-02f4-4294-a82e-71d8964e3978#bkmk_consumer) ถ้าคุณไม่ต้องการใช้กล่องขาเข้าที่เน้น เลือกปุ่มด้านล่าง</span><span class="sxs-lookup"><span data-stu-id="a106c-p101">Focused Inbox helps you focus on what matters most. Email you're likely to read appears under Focused and the rest is moved to Other. To learn how it works, [read this](https://support.office.com/article/f445ad7f-02f4-4294-a82e-71d8964e3978#bkmk_consumer). If you don't want to use Focused Inbox, select the button below.</span></span>
